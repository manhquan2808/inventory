                    ...
                    <div class="col-12">
                        <div class="card">
                            <form class="form" action="" method="post" >
                                ...
                                <input type="text" name="idcanxoa" id="idcanxoa"  value="<?php echo $layid;?>">
                                <p id="heading">CREATE Production Plan</p>
                                <label for="idkhsx">ID Kế hoạch sản xuất</label>
                                <div class="field">
                                    <input autocomplete="off" placeholder="ID Kế hoạch sản xuất" id="idkhsx" name="idkhsx"
                                    class="input-field" type="text" required value="<?php 
                                    echo $p->chon_cot("select ID_KHSX from kehoachsanxuat where id='$layid' limit 1");  ?>">
                                </div>
                                <span id="idkhsxError" class="error"></span>
                                <label for="startdate">Ngày bắt đầu</label>
                                <div class="field">
                                    <input autocomplete="off" placeholder="Ngày bắt đầu" id="startdate" name="startdate"
                                        class="input-field" type="date" required value="<?php echo $p->chon_cot("select NgayBatDau from kehoachsanxuat where id='$layid' limit 1");  ?>">
                                </div>
                                <span id="startdateError" class="error"></span>
                                <label for="enddate">Ngày kết thúc</label>
                                <div class="field">
                                    <input autocomplete="off" placeholder="ngày kết thúc" id="enddate" name="enddate"
                                        class="input-field" type="date" required value="<?php 
                                        echo $p->chon_cot("select NgayKetThuc from kehoachsanxuat where id='$layid' limit 1");  
                                        ?>">
                                </div>
                                ...
                                <div class="field">
                                    <select name="trangthai" id="trangthai" class="input-field">
                                        <option value="đang lên kế hoạch" <?php if ($p->chon_cot("select TrangThai from kehoachsanxuat where id='$layid' limit 1") === 'đang lên kế hoạch') echo 'selected'; ?>>đang lên kế hoạch</option>
                                        <option value="đang thực hiện" <?php if ($p->chon_cot("select TrangThai from kehoachsanxuat where id='$layid' limit 1") === 'đang thực hiện') echo 'selected'; ?>>đang thực hiện</option>
                                        <option value="đã hoàn thành" <?php if ($p->chon_cot("select TrangThai from kehoachsanxuat where id='$layid' limit 1") === 'đã hoàn thành') echo 'selected'; ?>>đã hoàn thành</option>
                                    </select>
                                </div>
                                ...
                                <div class="field">
                                    <input autocomplete="off" placeholder="id phê duyệt" id="IDPheDuyet" name="IDPheDuyet"
                                        class="input-field" type="text"  value="<?php echo $p->chon_cot("select ID_BGD_PheDuyet from kehoachsanxuat where id='$layid' limit 1");  ?>" required>
                                </div>
                             
                                <span id="IDPheDuyetError" class="error"></span>
                                <div class="button1">
                                    <input type="submit" name="nut" id="nut" value="Thêm kế hoạch sản xuất">
                                    <input type="submit" name="nut" id="nut" value="Sửa kế hoạch sản xuất">
                                    <input type="submit" name="nut" id="nut" value="Xóa kế hoạch sản xuất">
                                </div>
                                <div class="col-12">
                                    <?php
                ...
                switch($_POST['nut'])
                {
                    ...
                    case'Sửa kế hoạch sản xuất':
                    {
                        ...
                        }else
                        {
                                ...
                                echo 'vui lòng chọn kế hoạch cần sửa.';	
                        }
                        break;	
                    }
                    ...
                    {	
                        ...
                        {
                            echo 'vui lòng chọn kế hoạch cần xóa.';	
                        }
                        break;
                    }
